...
public class BookTicketsVolvo {
	...
	static {
		hashMap.put("AndhraBangalore", 200);
		hashMap.put("AndhraChennai", 400);
		hashMap.put("BangaloreChennai", 200);
	}

	public static void Volvobook() throws SeatNotAvailableException, RouteNotFoundException {
...
//
		...
		BookTicketsVolvo booktickets1 = new BookTicketsVolvo();
		booktickets1.AvailableSeatsforVolvo();
...
// booktickets2.AvailableSeatsforVolvo();
	...
	public void AvailableSeatsforVolvo() {
		System.out.println();
		System.out.println("Availble upper seats for volvo bus:"); //
// u.forEach(System.out::print);
		u.forEach(i -> System.out.print("U" + i + " "));

		System.out.println();
		System.out.println("Available lower seats for volvo bus:");
	...
	public void AvailableSeatsAfterBooking() {
		System.out.println();
		System.out.println("After booking available upper seats for volvo bus");
		u.forEach(i -> System.out.print("U" + i + " "));

		System.out.println();
		System.out.println("After booking available lower seats for volvo bus");
...
// for cancel tickets
	...
	static void volvocancel() {
		BookTicketsVolvo booktickets2 = new BookTicketsVolvo();
		Scanner s = new Scanner(System.in);
